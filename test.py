...
if 'ds_assessment' not in fieldnames:
    fieldnames = list(fieldnames) + ['ds_assessment', 'ds_corrected']
...
for i, row in enumerate(rows):
    ...
    try:
        ...
        if ds_assessment == "Major issues":
            print(f"Major issues found, generating correction of report {i}...")
        ...
        print(f"Error during DeepSeek assessment on line {i}: {e}")
        ds_assessment = "ERROR"
        corrected_report = ""
    ...
    print(f"Row {i} completed: {ds_assessment}")
